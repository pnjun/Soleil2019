...
file1 = "day2/Scan_devices_X2p_RAM_NEXAFS_020.txt"
file2 = "day2/Scan_devices_X2p_RAM_NEXAFS_021.txt"
...
plotUtils.plot(xrange,energy,data, name="2TU-2p", plotlist=plotlist)
